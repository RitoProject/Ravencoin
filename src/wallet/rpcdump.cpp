    ...
    if (!seed_id.IsNull())
    {
        ...
        if (!pwallet->GetHDChain().IsBip44()) {
            ...
            if (pwallet->GetKey(seed_id, seed)) {
                ...
                // Get the Rito Ext Key from the master key
                CRitoExtKey b58extkey;
                b58extkey.SetKey(masterKey);
                ...
                // Get the Rito Ext Key from the public key
                CRitoExtPubKey b58extpubkey;
                b58extpubkey.SetKey(pubkey);
                ...
                // Create the Rito Account Ext Private Key
                CRitoExtKey b58accountextprivatekey;
                b58accountextprivatekey.SetKey(accountKey);

                // Create the Rito Account Ext Public Key
                CRitoExtPubKey b58actextpubkey;
