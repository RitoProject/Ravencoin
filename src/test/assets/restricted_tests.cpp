...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler rito tx
        CScript ritoTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut ritoOut(1*COIN, ritoTransfer);
        ...
        mutTxTest1.vout.emplace_back(ritoOut);
        ...
        mutTxTest2.vout.emplace_back(ritoOut);
        ...
        mutTxTest3.vout.emplace_back(ritoOut);
        ...
        mutTxTest4.vout.emplace_back(ritoOut);
        ...
        mutTxTest5.vout.emplace_back(ritoOut);
        ...
        mutTxTest6.vout.emplace_back(ritoOut);
        ...
        mutTxTest7.vout.emplace_back(ritoOut);
        ...
        mutTxTest8.vout.emplace_back(ritoOut);
