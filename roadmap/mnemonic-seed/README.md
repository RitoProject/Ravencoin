...
When using the 12-word seed which will be the new default, the address derivation will change to be compatible with the BIP32/BIP39/BIP44 standards.  Since this is already implemented in the Ritocoin mobile wallet, the 12-words will be cross-compatible.  The derivation path is m/44'/19169'/0'/0 for the first non-change address.
...
* Seed-based master key (BIP39): BIP32/BIP44  m/44'/19169'/0'/0
...
### Compatibility
Other wallets like Jaxx and Coinomi use a 12-word seed.  For wallets that use BIP39/BIP32/BIP44 and the correct coinid of 19169 for Ritocoin, the 12-words should be compatible with external wallets.
